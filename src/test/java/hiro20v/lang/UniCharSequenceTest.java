...
public class UniCharSequenceTest {
	...
	/**
	 * Test method for {@link hiro20v.lang.UniCharSequence#subSequence(int, int)}.
	 */
	@Test
	...
	public void testCompareTo2() {
		...
		final String[] defaultOrder = new String[] { //
				new String(new int[] { Character.MIN_CODE_POINT }, 0, 1), new String(new int[] { TestConstants.U10000 }, 0, 1), new String(new int[] { TestConstants.UE0100 }, 0, 1), new String(new int[] { TestConstants.UE01EF }, 0, 1), new String(new int[] { Character.MAX_CODE_POINT }, 0, 1), new String(new int[] { TestConstants.UFE00 }, 0, 1), new String(new int[] { TestConstants.UFE0F }, 0, 1), new String(new int[] { TestConstants.UFFFF }, 0, 1), };
		...
		final String[] uniCharSequenceOrder = new String[] { //
				new String(new int[] { Character.MIN_CODE_POINT }, 0, 1), new String(new int[] { TestConstants.UFE00 }, 0, 1), new String(new int[] { TestConstants.UFE0F }, 0, 1), new String(new int[] { TestConstants.UFFFF }, 0, 1), new String(new int[] { TestConstants.U10000 }, 0, 1), new String(new int[] { TestConstants.UE0100 }, 0, 1), new String(new int[] { TestConstants.UE01EF }, 0, 1), new String(new int[] { Character.MAX_CODE_POINT }, 0, 1), };
	...
	/**
	 * Test method for {@link hiro20v.lang.UniCharSequence#getInformation()}.
	 */
	@Test
	public void testGetInformation() {

		assertThat("", new UniCharSequence(TestConstants.SAMPLE_STRING_VARIATION).getInformation(), notNullValue());
	}
}
