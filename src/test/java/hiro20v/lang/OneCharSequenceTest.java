...
public class OneCharSequenceTest {
    ...
    public void testHashCode() {
        ...
        assertThat("", new OneCharSequence(new UniCharSequence(TestConstants.SAMPLE_STRING_VARIATION)).hashCode(),
                is(TestConstants.SAMPLE_STRING_VARIATION.hashCode()));
    ...
    /**
     * Test method for
     * {@link hiro20v.lang.OneCharSequence#subSequence(int, int)}.
     */
    @Test
    ...
    public void testToOneCharSequenceIgnoreVariation() {
        ...
        final OneCharSequence sequence = new OneCharSequence(new UniCharSequence(SAMPLE_STRING));
        assertThat("", sequence.toOneCharSequenceIgnoreVariation(),
                is(new OneCharSequence(new UniCharSequence(PATTERN_VARIATION_SELECTOR.matcher(SAMPLE_STRING).replaceAll("")))));
    }
    ...
    public void testCompareTo2() {
        ...
        final Comparator<String> comparator = (final String s1, final String s2) -> new OneCharSequence(new UniCharSequence(s1))
                .compareTo(new OneCharSequence(new UniCharSequence(s2)));
    ...
    public void testCompareTo3() {
        ...
        order = new String[] { //
                TestConstants.SAMPLE_U9089 + TestConstants.SAMPLE_UE0110 + TestConstants.SAMPLE_U9089 + TestConstants.SAMPLE_UE010F, // '邉'+VS18,'邉'+VS17
                TestConstants.SAMPLE_U9089 + TestConstants.SAMPLE_UE010F + TestConstants.SAMPLE_U9089 + TestConstants.SAMPLE_UE0110
    ...
    /**
     * Test method for {@link hiro20v.lang.OneCharSequence#getInfomation()}.
     */
    @Test
    public void testGetInfomation() {

        assertThat("", new OneCharSequence(new UniCharSequence(TestConstants.SAMPLE_STRING_VARIATION)).getInfomation(), notNullValue());
    }
}
