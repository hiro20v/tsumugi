...
public class OneChar implements Comparable<OneChar> {
	...
	Information getInformation() {
		...
		information.setName(OneChar.class.getSimpleName());

		information.getProperties().put(String.class.getSimpleName(), "'" + this.toString() + "'");
		information.getProperties().put("UniChar count", String.valueOf(this.toUniCharList().size()));

		this.toUniCharList().forEach(uniChar -> information.getChildInformations().add(uniChar.getInformation()));
